...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_serrviceId_fkey" FOREIGN KEY ("serrviceId") REFERENCES "BarbershopService"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
